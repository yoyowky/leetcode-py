...
document.getElementById('js-show-all').addEventListener('click', function(){
    if(contactList){ //check if we already have a contact list
    ...
    document.getElementById('js-search').classList.remove('active');
    document.getElementById('js-add-new').classList.remove('active');
    document.getElementById('js-show-all').classList.add("active");
  });
  ...
  document.getElementById('js-search').addEventListener('click', function(){
    ...
    document.getElementById('contact-panel').style.display = 'none';
    document.getElementById('js-show-all').classList.remove('active');
    document.getElementById('js-add-new').classList.remove('active');
    document.getElementById('js-search').classList.add("active");
  });
  ...
  document.getElementById('js-add-new').addEventListener('click', function(){
    ...
    document.getElementById('js-show-all').classList.remove('active');
    document.getElementById('js-search').classList.remove("active");
    document.getElementById('js-add-new').classList.add('active');
  });
...
//     window.contactList=new AddressBook();
//    }
 
//  var form  = document.getElementById('contact');
//  form.addEventListener('submit', function(){
//     if(!window.contactList){ //check if we already have a contact list
//     window.contactList=new AddressBook(form.person.value,form.phone.value,form.email.value);
//    } else {
